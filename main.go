...
// Приведу несколько особенностей:
...
// любой отрезок всегда под собой имеет массив, изменение в этом отрезке, в открезках от первоначаьлного отрезка,
...
func sliceCreate() {
	...
	// (особенность) При каждом добавлении с append, если длина изначального массива недостаточна (емкость среза), то она увидичивается в 2 раза
}

// .
// . Чтобы скопировать массив и срез
// . Нужно помнить что функция коппирования скопирует ссылки на те же элементы и все внутренние ссылки тоже
// в стандарте нет функции deepCopy
